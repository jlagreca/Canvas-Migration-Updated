...
token = "" # access_token
workingPath = "/Volumes/migration"; # Important! Make sure this ends with a backslash
CSVFileName = "some.csv" # The name of the course copy CSV file.  Not the full path

source_archive_filename_column = "source"
canvas_domain = "YOURDOMAIN.instructure.com"  # Your Canvas domain.  Use the .test area at first
...
def massDoCopies(data):
  ...
  course_search_url = "https://{}/api/v1/courses/sis_course_id:{}".format(canvas_domain,row_data['destination_id'])
  ...
  if not found_course.get('id',None):
    ...
    if process_type == 'upload':
      ...
      course_quota_url = "https://{}/api/v1/courses/sis_course_id:{}/files/quota".format(canvas_domain,row_data['destination_id'])
    ...
    uri = "https://{}/api/v1/courses/sis_course_id:{}/content_migrations".format(canvas_domain,row_data['destination_id'])
    ...
    if process_type=='upload':
      ...
      migration_json = requests.get('https://{}/api/v1/courses/sis_course_id:{}/content_migrations/{}'.format(canvas_domain,row_data['destination_id'],migration_json['id']),headers=headers).json()
